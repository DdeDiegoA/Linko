            ...
            {socials.map((s) => {
              ...
              return (
                <a
                  ...
                  className="font-display flex h-11 w-11 items-center justify-center rounded-full border border-border bg-surface text-base font-semibold no-underline transition-transform hover:scale-110"
